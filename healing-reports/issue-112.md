# OPEN_AI Healing Report - Issue #112

**Issue:** [Bug] In production, Guest Login fails. The login API request returns 404 and the UI shows login failed behavior.
**Model:** gpt-4o-mini
**Generated at:** 2026-06-22T12:43:27.866Z
